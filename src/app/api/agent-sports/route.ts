...
2. 초집중 타겟: **한국인 선수(손흥민, 이정후, 김하성 등) 및 일본인 선수(오타니, 야마모토 등)가 소속된 팀**의 극적인 명승부, 이적, 부상, 기록 달성 등의 강력한 이슈를 최우선으로 하세요. 
3. 출력 형식 제한: 뻔한 팀의 이름보다는 상황이 구체적으로 묘사된 롱테일 키워드로 지어주세요. (예: "오타니 50홈런 달성", "이정후 멀티히트 하이라이트", "샌안토니오 웸반야마 활약상")
