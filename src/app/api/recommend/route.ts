...
사용자가 선택한 카테고리(${category})와 기간(${timeframe}) 동안 가장 사람들의 검색량이 많고 주목받는(Trending) 블로그 추천 키워드를 5개만 뽑아주세요.
...
3. 기호나 번호, 설명, 따옴표 없이, 오직 키워드 자체만 한 줄에 하나씩 응답하세요. (정확히 5개의 줄이어야 함)
